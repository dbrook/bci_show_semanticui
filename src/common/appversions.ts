...
export const applicationVersion: string = '3.0.0';
export const copyrightYearRange: string = '2022-2025';
...
export const database: string = 'Dexie 3.2.2';
export const codeRepo: string = 'https://github.com/dbrook/bci_show_semanticui/issues';
