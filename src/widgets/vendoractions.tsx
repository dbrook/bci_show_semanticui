    ...
    if (condensedView) {
      return <div>
          ...
          <div className='BCImobilevendorstatus'>
            ...
            <NumericalProgress label='QU' completed={this.nbAnsweredQuestions(questions)} total={questions.length}/>
            <NumericalProgress label='PB' completed={this.nbSubmitted(powerBuys)} total={powerBuys.length}/>
            <NumericalProgress label='PC' completed={this.nbSubmitted(profitCenters)} total={profitCenters.length}/>
